...
var Heartbeats = /** @class */ (function () {
    function Heartbeats() {
    }
    Heartbeats.prototype.getAPIInstance = function () {
        var onlineServicesServerAPIEndPoint = window["onlineServicesServerAPIEndPoint"] || '';
        return axios.create({
    ...
    Heartbeats.prototype.sendHeartbeat = function (heartbeatObject) {
        return __awaiter(this, void 0, void 0, function () {
    ...
    Heartbeats.prototype.makeHeartbeat = function (periodInSeconds) {
        return new Promise(function (resolve, reject) {
            var identityHandler = new identities_1.Identities();
            var identityObject = identityHandler.getIdentityFromLocalStorage();
            setTimeout(function () {
...
},{"./identities":2,"axios":4}],2:[function(require,module,exports){
"use strict";
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    function adopt(value) { return value instanceof P ? value : new P(function (resolve) { resolve(value); }); }
    return new (P || (P = Promise))(function (resolve, reject) {
...
var axios = require("axios");
var Identities = /** @class */ (function () {
    function Identities() {
    }
    Identities.prototype.getAPIInstance = function () {
        var onlineServicesServerAPIEndPoint = window["onlineServicesServerAPIEndPoint"] || '';
        return axios.create({
            baseURL: onlineServicesServerAPIEndPoint,
            headers: {
    ...
    Identities.prototype.saveIdentityObjectToLocalStorage = function (identityObject) {
    ...
    Identities.prototype.getIdentityFromLocalStorage = function () {
    ...
    Identities.prototype.isThereAlreadyAnIdentityInLocalStorage = function () {
        var identityObject = this.getIdentityFromLocalStorage();
        return identityObject.uuid !== '';
    };
    Identities.prototype.identityCheck = function () {
        var _this = this;
        if (!this.isThereAlreadyAnIdentityInLocalStorage()) {
            this.issueNewIdentity()
                .then(function (identityObject) { return _this.saveIdentityObjectToLocalStorage(identityObject); })
                .then(function (identityObject) { return _this.validateIdentity(identityObject); })
    ...
    Identities.prototype.issueNewIdentity = function () {
        return __awaiter(this, void 0, void 0, function () {
            var instance, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    Identities.prototype.validateIdentity = function (identitiesObject) {
        return __awaiter(this, void 0, void 0, function () {
            var instance, response;
            return __generator(this, function (_a) {
                switch (_a.label) {
...
var identities_1 = require("./identities");
var OnlineServicesFrontendEntry = /** @class */ (function () {
    function OnlineServicesFrontendEntry() {
    }
    OnlineServicesFrontendEntry.prototype.onLoaded = function (event) {
        var identitiesHandler = new identities_1.Identities();
        var heartbeatsHandler = new heartbeats_1.Heartbeats();
        identitiesHandler.identityCheck();
        heartbeatsHandler.transmittingHeartbeats();
    };
    return OnlineServicesFrontendEntry;
}());
var entry = new OnlineServicesFrontendEntry();
window.addEventListener("load", function (event) { return entry.onLoaded(event); });

},{"./heartbeats":1,"./identities":2}],4:[function(require,module,exports){
